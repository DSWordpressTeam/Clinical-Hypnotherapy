 ...
 */
class Mentor_Menu_Mobile extends Widget_Base{
	...
	public function get_title() {
		return __( 'OT Menu Mobile', 'mentor' );
	}
	...
	protected function register_controls() {
		...
		$this->add_control(
			'pos_menu',
			[
				'label' => __( 'Position', 'mentor' ),
				'type' => Controls_Manager::SELECT,
				'default' => 'on-right',
				'options' => [
					'on-left' 	=> __( 'On Left', 'mentor' ),
					'on-right'  => __( 'On Right', 'mentor' ),
				]
			]
		);
		...
		$this->add_control(
			'color_back',
			[
				'label' => __( 'Back Button Color', 'mentor' ),
				'type' => Controls_Manager::COLOR,
				'default' => '',
				'selectors' => [
...
// After the Mentor_Menu_Mobile class is defined, I must register the new widget class with Elementor:
Plugin::instance()->widgets_manager->register_widget_type( new Mentor_Menu_Mobile() );